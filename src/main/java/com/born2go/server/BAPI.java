...
//			realPost = dataService.findPath(postID);
//			if (realPost != null){
...
//			insertedPost = dataService.insertPath(realPost, tripID, accessToken);
//		}
//		else {
//			realPost.setTitle(titleStr);
//			realPost.setDescription(postHtml);
...
//		String html = "";
//		Path path = dataService.findPath(id);
//		if (path != null){
...
//		String jsonRet = "";
//		Path post = dataService.findPath(id);
//		if (post != null){
//			Gson gson = new Gson();
