...
public class CKConfig {
	...
	public CKConfig(PRESET_TOOLBAR toolbar) {
		...
		if (l.getLocaleName().equals("default")) {
			// GWT.log("[gwt-CKEditor]Locale Property : " + getLocaleProperty(),
			// null);
	...
	private native void setNativeFilebrowserFlashBrowseUrl(
			String fileBrowserFlashBrowserUrl) /*-{
		this.@com.axeiya.gwtckeditor.client.CKConfig::config.fileBrowserFlashBrowserUrl = fileBrowserFlashBrowserUrl;
	}-*/;

	private native void setNativeFilebrowserUploadUrl(
			String filebrowserUploadUrl) /*-{
		this.@com.axeiya.gwtckeditor.client.CKConfig::config.filebrowserUploadUrl = filebrowserUploadUrl;
	}-*/;

	private native void setNativeFilebrowserImageUploadUrl(
	...
	private native void setNativeFilebrowserFlashUploadUrl(
			String filebrowserFlashUploadUrl) /*-{
